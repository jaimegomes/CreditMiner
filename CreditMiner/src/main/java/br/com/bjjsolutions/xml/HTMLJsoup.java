...
public class HTMLJsoup {
    ...
    public HTMLJsoup(String html) {
        if (Cache.clientesCache == null) {
            Cache.clientesCache = new TreeMap();
        }
        try {
...
//                }
//                if (Cache.clientesCache.containsKey(produtoObj.getCodProduto()) == false && !produtoObj.getCodProduto().isEmpty()
//                        && !produtoObj.getDescProduto().isEmpty() && !produtoObj.getPreco().isEmpty() && !produtoObj.getPreco().isEmpty()) {
//                    Cache.clientesCache.put(produtoObj.getCodProduto(), produtoObj);
//                }
//            }
